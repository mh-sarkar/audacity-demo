...
part of 'new_shop.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class NewShopAdapter extends TypeAdapter<NewShop> {
  @override
  final int typeId = 4;

  @override
  NewShop read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, NewShop obj) {
    writer
      ..writeByte(22)
      ..writeByte(0)
      ..write(obj.slNo)
